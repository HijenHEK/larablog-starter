            ...
            <form id="contact" action="/contact" method="post">
                ...
                <div class="row">
                    <div class="group">
                        ...
                        <input name="name" class="control" type="text" id="name" placeholder="Your name" required="">
                        @error('name')
                    ...
                    <div class="group">
                        ...
                        <input name="email" class="control" type="text" id="email" placeholder="Your email" required="">
